...
public class EmpProcessor {
    public static void main(String[] args) {
        ...
        System.out.printf("%n First employee who earns $4000-$6000: %n%s%n", list.stream().filter(fourToSixThousand).findFirst().get());

        Function<Employee, String> byFirstName = Employee::getFirstName;
        Function<Employee, String> byLastName = Employee::getFirstName;
        ...
        list.stream().sorted(lastThenFirst).map(Employee::getFirstName).forEach(System.out::println);
